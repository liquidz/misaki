...
(fact "sort-posts should work fine."
  (let [sample-posts [
                {:file (io/file "b") :n 2}
                {:file (io/file "c") :n 3}
                {:file (io/file "a") :n 1}
                ]
        res (sort-posts sample-posts)
        ]
...
(facts "blog-main should work fine."
  (let [-main (blog-main-fn)]
